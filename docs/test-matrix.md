...
| Parches de fuente y undo/redo | Unitario | Parcial | Pendiente | `editor::EditHistory` preserva UTF-8, revisiones, undo/redo y presupuesto de 4 MiB; `SourceEditor` fija cursor y selección Unicode, incluida la columna vertical por caracteres. Falta interacción, IME y round-trip de guardado |
