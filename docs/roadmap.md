...
| Editor básico | En curso | Abrir, crear, buffer escalable, edición fuente, guardado atómico, conflictos explícitos y recuperación local configurable; faltan vista dividida, actualización incremental del modelo fuente y QA manual de los diálogos nativos |
...
| Workspace | En curso | Carpeta explícita, VFS, índice acotado/cancelable y paneles de notas y búsqueda; faltan jerarquía del árbol y actualización por cambios externos |
