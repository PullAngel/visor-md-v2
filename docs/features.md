...
| Búsqueda en documento | Parcial | `Ctrl+F` local, Unicode sin distinción de mayúsculas, término activo resaltado y marcas de bloques coincidentes sobre el recorrido completo; falta QA visual y varias coincidencias dentro del mismo bloque |
