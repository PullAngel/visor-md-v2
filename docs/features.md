...
| Divisiones de documentos | Parcial | Desde Más acciones o la paleta se puede elegir una pestaña elegible y dividir a la derecha o abajo, hasta cuatro archivos distintos. Cada hoja aísla dibujo, scroll y foco; cerrar una hoja conserva la pestaña. Faltan navegación de foco por teclado, transición, QA visual y ventanas separadas. |
...
| Barra de acciones | Parcial | En lectura prioriza archivo, búsqueda y espacio de trabajo; un selector segmentado directo cambia entre Leer, Editar y Comparar sin recorrer estados. Su indicador interior se desplaza durante 180 ms sin mover contenido ni retrasar la acción. En edición muestra guardar y ayudas Markdown esenciales. Mouse y F6 comparten acciones; 640 × 480 lógicos evita controles ocultos; falta semántica de lector de pantalla |
...
| Reducir movimiento | Parcial | Acción persistente local que vuelve instantáneo el cambio de tema y el indicador del selector de modo; no guarda contenido, rutas ni permisos. Debe cubrir paneles, pestañas y futuras divisiones cuando tengan transición visual |
