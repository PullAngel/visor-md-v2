...
| Búsqueda de carpeta | Busca título, ruta, encabezados y contenido indexado; su cabecera identifica la carpeta autorizada. | Los resultados muestran principalmente rutas: son difíciles de escanear y no indican por qué coincidieron. | Mostrar título/ruta secundaria y un fragmento o encabezado coincidente, sin guardar contenido fuera del índice ya permitido. |
