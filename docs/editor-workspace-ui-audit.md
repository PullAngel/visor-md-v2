...
| Wikilinks | Soporta destino, alias y encabezado, con ambigüedad bloqueada; la fixture fija que una coincidencia corta ambigua no genera backlink. El hub abre un panel persistente de solo lectura por enlace, con estado resuelto, ausente o ambiguo, sin releer disco. | Falta QA visual de textos largos y una futura acción explícita para navegar desde un resultado resuelto. | Mantener el panel inerte hasta que esa navegación tenga una UX y política de seguridad claras. |
