...
| Wikilinks | Soporta destino, alias y encabezado, con ambigüedad bloqueada; la fixture fija que una coincidencia corta ambigua no genera backlink. El hub resume enlaces resueltos, ausentes y ambiguos sin releer disco. | El resumen es breve; todavía no hay una vista persistente por enlace. | Incorporar un diagnóstico contextual de solo lectura, limitado al documento actual, después de estabilizar la navegación base. |
